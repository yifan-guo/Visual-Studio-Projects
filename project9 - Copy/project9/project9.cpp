...
void main() {
	...
	try {		//case: inserting an empty string into the Trie
		...
		cout << "An exception was successfully thrown and caught: " << excpt.what() << endl;
	}
	...
	cout << "---Trie2 should have 9 words in alphabetical order.\n" << endl;
	trie2.print();		//tests print() [in alphabetical order]

	if (trie2.wordCount() == 9) {
...
//-----------------------Compiler provided Big 3--------------------
	...
	//-------------insertFromFile into a Trie that is not empty--------
	...
	if (trie1.wordCount() == 8) {
		...
		cout << "WRONG: WordCount incorrect after loadFromFile into non-empty Trie." << endl;
	}
